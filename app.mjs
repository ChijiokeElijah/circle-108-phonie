...
window.startApp = function() {
  ...
  let airtel1 = ['0701', '0708', '0808', '0812', '0902', '0907', '0802'];
  ...
  let airtel2 = ['+234701', '+234708', '+234808', '+234812', '+234902', '+234907', '+234802'];
  ...
  for (let i = 0; i < mtn1.length || i < mtn2.length || i < airtel1.length || i < airtel2.length || i < glo1.length || i < glo2.length || i < nineMobile1.length || i < nineMobile2.length; i++) {
    if ((inputValueString.startsWith(mtn1[i]) && inputValueLength == 11) || (inputValueString.startsWith(mtn2[i]) && inputValueLength == 14)) {
      airtelLogo.style.display = 'none'
      gloLogo.style.display = 'none'
      nineMobileLogo.style.display = 'none'
    ...
    else if ((inputValueString.startsWith(airtel1[i]) && inputValueLength == 11) || (inputValueString.startsWith(airtel2[i]) && inputValueLength == 14)) {
      mtnLogo.style.display = 'none'
      gloLogo.style.display = 'none'
      nineMobileLogo.style.display = 'none'
      invalidNumber.style.display = 'none'
    ...
    else if ((inputValueString.startsWith(glo1[i]) && inputValueLength == 11) || (inputValueString.startsWith(glo2[i]) && inputValueLength == 14)) {
      mtnLogo.style.display = 'none'
      airtelLogo.style.display = 'none'
      nineMobileLogo.style.display = 'none'
      invalidNumber.style.display = 'none'
    ...
    else if ((inputValueString.startsWith(nineMobile1[i]) && inputValueLength == 11) || (inputValueString.startsWith(nineMobile2[i]) && inputValueLength == 14)) {
      mtnLogo.style.display = 'none'
      airtelLogo.style.display = 'none'
      gloLogo.style.display = 'none'
      invalidNumber.style.display = 'none'
